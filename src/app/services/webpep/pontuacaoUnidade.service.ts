...
@Injectable()
export class PontuacaoUnidadeService {
    url: string = 'web/pep/';
    private servidor;
    ...
    get(objParams) {
        const url = `${this.url}unidadeAtendimentoPontuacao/${Sessao.getToken()}`;
    ...
    atualizar(id, objTipo) {
        const url = `${this.url}unidadeAtendimentoPontuacao/${Sessao.getToken()}/${id}`;

...
@Injectable()
export class ProgramaSaudePacienteService {
    url: string = 'web/pep/';
    private servidor;
    ...
    get(params = {}) {
        const url = `${this.url}programaSaudePaciente/${Sessao.getToken()}`;
    ...
    put(id, request) {
        const url = `${this.url}programaSaudePaciente/${Sessao.getToken()}/${id}`;

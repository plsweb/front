...
export class TipoMovimentoService {
    ...
    get(request = {}, geturl = false){
        const url = `${this.url}tipoMovimento/${Sessao.getToken()}`;
    ...
    delete(id){
        const url = `${this.url}tipoMovimento/${Sessao.getToken()}/${id}`;
    ...
    put(request){
        const url = `${this.url}tipoMovimento/${Sessao.getToken()}/${request.id}`;
